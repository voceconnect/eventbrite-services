	...
	static function &init() {
		...
		if ( !$instance ) {
			register_post_type( 'kr_request_token', array(
				'label'       => __( 'Keyring Request Token', 'eventbrite-parent' ),
				'description' => __( 'Token or authentication details stored by Keyring. Request tokens are used during the authorization flow.', 'eventbrite-parent' ),
				'public'      => false,
			) );

			register_post_type( 'kr_access_token', array(
				'label'       => __( 'Keyring Access Token', 'eventbrite-parent' ),
				'description' => __( 'Token or authentication details stored by Keyring. Access tokens are used to make secure requests.', 'eventbrite-parent' ),
				'public'      => false,
			) );
